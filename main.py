...
def towerplace():
    ...
    while pixels_moved_down < 370:
        ...
        while pixels_moved_right < 900:
            ...
            if (pyautogui.locateOnScreen("defooted.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
                while True:
                    if (pyautogui.locateOnScreen("defooted.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
                        ...
                        pyautogui.leftClick()
                        return
            if (pyautogui.locateOnScreen("victree.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
                while True:
                    if (pyautogui.locateOnScreen("victree.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
                        pyautogui.moveTo(pyautogui.locateOnScreen("chest.png", confidence=0.9))
                        pyautogui.moveTo(pyautogui.locateOnScreen("battle_chest.png", confidence=0.9))
...
def btdb():
    ...
    if (pyautogui.locateOnScreen("defooted.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
        if pyautogui.locateOnScreen("chest.png", confidence=0.95) != None:
            pyautogui.moveTo(pyautogui.locateOnScreen("chest.png", confidence=0.9))
            pyautogui.move(0, 440, 6 + random.uniform(0, 3))
            pyautogui.move(random.randrange(-5, 5), random.randrange(-5, 5))
            pyautogui.leftClick()
    ...
    if (pyautogui.locateOnScreen("Chests-full.png", confidence=0.8) != None) or (pyautogui.locateOnScreen("Chests-full-LI.png", confidence=0.8) != None):
        ...
        if (pyautogui.locateOnScreen("defooted.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
            if pyautogui.locateOnScreen("chest.png", confidence=0.95) != None:
                ...
                return
        if (pyautogui.locateOnScreen("victree.png", confidence=0.8) != None) or ( pyautogui.locateOnScreen("chest.png", confidence=0.8) != None):
            if (pyautogui.locateOnScreen("chest.png", confidence=0.95) != None) or (
                    pyautogui.locateOnScreen("battle_chest.png", confidence=0.8) != None):
                pyautogui.moveTo(pyautogui.locateOnScreen("chest.png", confidence=0.9))
                pyautogui.move(0, 440, 6 + random.uniform(0, 3))
                pyautogui.move(random.randrange(-5, 5), random.randrange(-5, 5))
                pyautogui.leftClick()
            ...
            if pyautogui.locateOnScreen("Ready-hero-button.png", confidence=0.8) != None:
                ...
                while True:
                    if pyautogui.locateOnScreen("Chests-full.png", confidence=0.8) != None:
                        ...
                        pyautogui.move(random.randrange(-5, 5), random.randrange(-5, 5))
                        pyautogui.leftClick()
                        print('got rid of pesky chest screen', 'Current time:',
                        ...
                        while True:
                            ...
                            if (pyautogui.locateOnScreen("top-left.png", confidence=0.95) != None) or (pyautogui.locateOnScreen("alt-top-left.png", confidence=0.95) != None):
                                ...
                                while True:
                                    ...
                                    sleep(2 + random.uniform(0, 2))
                                    if (pyautogui.locateOnScreen("Chests-full.png", confidence=0.8) != None) or (
                                            pyautogui.locateOnScreen("Chests-full-LI.png", confidence=0.8) != None):
                                        pyautogui.moveTo(pyautogui.locateOnScreen("Chests-full.png", confidence=0.8))
                                        pyautogui.moveTo(pyautogui.locateOnScreen("Chests-full-LI.png", confidence=0.8))
                                        pyautogui.move(random.randrange(-5, 5), random.randrange(-5, 5))
                                        pyautogui.leftClick()
                                    ...
                                    if pyautogui.locateOnScreen("surrender.png", confidence=0.82) != None:
                                        ...
                                        while True:
                                            ...
                                            if (pyautogui.locateOnScreen("Chests-full.png",confidence=0.8) != None) or (pyautogui.locateOnScreen("Chests-full-LI.png",confidence=0.8) != None):
                                                pyautogui.moveTo(pyautogui.locateOnScreen("Chests-full.png", confidence=0.8))
                                                pyautogui.moveTo(autogui.locateOnScreen("Chests-full-LI.png", confidence=0.8))
                                                pyautogui.move(random.randrange(-5, 5), random.randrange(-5, 5))
                                                pyautogui.leftClick()
                                                pyautogui.move(120, 0, 3)
                                                print('got rid of pesky chest screen', 'Current time:',datetime.today().strftime("%I:%M:%S %p"))
